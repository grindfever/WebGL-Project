...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // a slider for changing the scale of the object
        this.gui.add(this.scene, 'scaleFactor', 0.1, 10.0).name('Scale');

        // a slider for changing the object's complexity
        this.gui.add(this.scene, 'objectComplexity', 0.01, 1.0).onChange(this.scene.updateObjectComplexity.bind(this.scene));

        // a dropdown for selecting the shader
        ...
        // a subfolder for grouping the three attenuation factors
